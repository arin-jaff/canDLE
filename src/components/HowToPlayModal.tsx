    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between border-b border-terminal-border px-4 py-3">
          <span className="text-xs text-terminal-green tracking-widest uppercase">HOW TO PLAY</span>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4 text-xs font-mono text-terminal-text leading-relaxed">
          <div>
            <div className="text-terminal-green mb-1">{'//'} OBJECTIVE</div>
          ...
          <div>
            <div className="text-terminal-green mb-1">{'//'} HINTS</div>
            <p className="text-terminal-muted">
              Buy hints to reveal clues about the stock: sector, market cap, HQ country,
              additional charts, company description, and more. Each hint costs 50-150 points.
            </p>
          </div>

          <div>
            <div className="text-terminal-green mb-1">{'//'} GUESSING</div>
            <p className="text-terminal-muted">
          ...
          <div>
            <div className="text-terminal-green mb-1">{'//'} SCORING</div>
            <p className="text-terminal-muted">
          ...
          <div>
            <div className="text-terminal-green mb-1">{'//'} DAILY</div>
            <p className="text-terminal-muted">
